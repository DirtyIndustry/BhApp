<template>
    <view class="wrap" @tap="pageTap">
        ...
        <view class="choose_source">
            ...
            <text class="text text-green">中国气象网&nbsp;&nbsp;</text>
        </view>
        <view class="separator"></view>
        <picSwiperAlt :imgArray="imageArray" :startIndex="startIndex" :autoStart="autostart" buttonFade="false" interval="1500"
        ...
        methods: {
            ...
            requestImage() {
                ...
                uni.request({
                    ...
                    data: { name: 'admin', areaflg: '北海', source: '中国' },
                    method: 'POST',
