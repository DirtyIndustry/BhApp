			...
			<view class="page-section" :class="{hide: !weihaiData.show}">
				...
				<view :class="{hide: !weihaiData.first.show}">
					...
					<view class="section-body">
						<weihaiSPChart :option="weihaiData.first.option" :data="weihaiData.first" canvasId="canvasIdWeihaiOne" />
					</view>
				</view>
				<view class="separator" />
				<!-- 第二部分 -->
				<view :class="{hide: !weihaiData.second.show}">
					...
					<!-- 图表部分 -->
					<view class="section-body">
						<weihaiSPChart :option="weihaiData.second.option" :data="weihaiData.second" canvasId="canvasIdWeihaiTwo" />
					</view>
				</view>
				<view class="separator" />
				<!-- 第三部分 -->
				<view :class="{hide: !weihaiData.third.show}">
					...
					<!-- 图表部分 -->
					<view class="section-body">
						<weihaiSPChart :option="weihaiData.third.option" :data="weihaiData.third" canvasId="canvasIdWeihaiThree" />
					</view>
				</view>
				<view class="separator" />
				<!-- 第四部分 -->
...
<script>
	...
	import weihaiSPChart from '../../components/weihaiSPChart.vue'
